							...
							<div class="row">
									...
									<div class="col-md-3">
												<div class="stat st-pending">
															...
															<div class="info">
																		Pending Members
																		<span><a href="members.php?do=Mange&Pending">
													...
													<div class="panel-body">
														...
														$stmt = $con->prepare("SELECT
																								...
																								echo '<span class="member-n"><a href="members.php?do=Edit&userid=' . $comment['user_id'] . '">' . $comment['Member'] . '</a></span>';
																									echo '<p class="comment-c">' . $comment['comment'] . '<br /><br />';
																										...
																										echo '<a href="comments.php?do=Delete&comid=' . $comment['c_id'] . '" class="btn btn-danger confirm"><i class="fa fa-close"></i> Delete</a> ';
																											...
																											if ($comment['status'] == 0) {
																												echo '<a href="comments.php?do=Approve&comid=' . $comment['c_id'] . '" class="btn btn-info"><i class="fa fa-close"></i> Approve</a>';
																											}
																										echo '</p>';
																							echo '</div>';
																						}
